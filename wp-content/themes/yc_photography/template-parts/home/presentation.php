...
<section id="presentation">
    ...
    <div class="div_presentation">
        ...
        <p class="p_presentation">
        Ma démarche est plutôt graphique, en cherchant plus des "impacts visuels" que signifiants ou symboliques. Je ne veux pas avoir d’approche documentariste. Au contraire, je réinterprète les lieux pour que mes photos au fil du temps se confondent et ne forment qu’un seul univers.
        </p>
        <p class="p_presentation">
